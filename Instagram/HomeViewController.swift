...
class HomeViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        // PostTableViewCell.xibに作成したセルの定義内容を取得→Outletで接続しているtableViewにregisterで登録
        ...
        // テーブル行の高さの概算値を設定しておく
        // 高さ概算値 = 「縦横比1:1のUIImageViewの高さ」+ 「イイネボタン、キャプションラベル、その他余白の高さの合計概算(=100pt)」
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        if Auth.auth().currentUser != nil {
            if self.observing == false {
                ...
                // 要素が変更された該当のデータをpostArrayから一度削除した後に新しいデータを追加してTableViewを再表示する
            ...
            if observing == true {
                ...
                // DatabaseのobserveEventが上記コードにより解除されたため→falseとする
                observing = false
            }
        }
    }
    ...
    @objc func commentHandleButton(_ sender: UIButton, forEvent event: UIEvent) {
        ...
        // postDataをcommentViewControllerに渡す
